...
$provider = new Bookingsync\OAuth2\Client\Provider\Bookingsync([
    ...
    'redirectUri'       => 'https://localhost/embedded_app.php', // https is mandatory for BookingSync
...
if (!isset($_GET['code'])) {
    ...
    // Embedded applications must use javascript to redirect to the auth screen.
    // Refer to http://developers.bookingsync.com/reference/authorization/#embedded-application
    // for more details.
    ?>
    <html>
      <body>
        <script type='text/javascript'>
          window.top.location.href = "<?php echo $authUrl; ?>";
        </script>
      </body>
    </html>
    <?php
