...
$provider = new Bookingsync\OAuth2\Client\Provider\Bookingsync([
    'clientId'          => 'XXXX',
    'clientSecret'      => 'XXXX',
    'redirectUri'       => 'https://localhost/updated_since.php', // https is mandatory for BookingSync
...
// Check given state against previously stored one to mitigate CSRF attack
    ...
    try {
        ...
        // Get bookings updated_since 2014-08-21 : http://developers.bookingsync.com/reference/endpoints/rentals/
        $request = new RestRequest('https://www.bookingsync.com/api/v3/bookings?updated_since=2014-08-21', 'GET');
